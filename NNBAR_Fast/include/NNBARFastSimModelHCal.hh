...
//
//
/// \file NNBARFastSimModelHCal.hh
/// \brief Definition of the NNBARFastSimModelHCal class

#ifndef NNBAR_HCAL_FAST_SIM_MODEL_H
#define NNBAR_HCAL_FAST_SIM_MODEL_H
...
class NNBARFastSimModelHCal : public G4VFastSimulationModel {
  public:
    ...
    NNBARFastSimModelHCal( G4String aModelName, G4Region* aEnvelope, 
    ...
    /// A constructor.
    /// @param aModelName A name of the fast simulation model.
    NNBARFastSimModelHCal( G4String aModelName );

    ~NNBARFastSimModelHCal();
    ...
    /// efficiency to the NNBARPrimaryParticleInformation.
    /// @param aFastTrack A track.
