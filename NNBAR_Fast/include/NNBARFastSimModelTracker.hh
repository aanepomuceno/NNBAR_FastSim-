...
//
//
/// \file NNBARFastSimModelTracker.hh
/// \brief Definition of the NNBARFastSimModelTracker class

#ifndef NNBAR_TRACKER_FAST_SIM_MODEL_H
#define NNBAR_TRACKER_FAST_SIM_MODEL_H
...
/// (by NNBARSmearer::SmearMomentum()) and the particle is placed at the
...
class NNBARFastSimModelTracker : public G4VFastSimulationModel {
  public:
    ...
    NNBARFastSimModelTracker( G4String aModelName, G4Region* aEnvelope, 
                         NNBARDetectorParametrisation::Parametrisation aParamType );
    ...
    /// A constructor.
    /// @param aModelName A name of the fast simulation model.
    NNBARFastSimModelTracker( G4String aModelName );

    ~NNBARFastSimModelTracker();
    ...
    /// resolution and efficiency to the NNBARPrimaryParticleInformation.
    /// @param aFastTrack A track.
  ...
  private:
    ...
    /// A pointer to NNBARDetectorParametrisation used to get the efficiency and
    /// resolution of the tracking detector for a given particle and
    /// parametrisation type.
    NNBARDetectorParametrisation* fCalculateParametrisation;
    
    /// A parametrisation type.
    NNBARDetectorParametrisation::Parametrisation fParametrisation;
};
