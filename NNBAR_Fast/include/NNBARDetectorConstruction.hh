...
//
//
/// \file NNBARDetectorConstruction.hh
/// \brief Definition of the NNBARDetectorConstruction class

#ifndef NNBAR_DETECTOR_CONSTRUCTION_H
#define NNBAR_DETECTOR_CONSTRUCTION_H
...
class NNBARDetectorConstruction : public G4VUserDetectorConstruction {
  public:
    
    /// A default constructor.
    NNBARDetectorConstruction();

    virtual ~NNBARDetectorConstruction();
