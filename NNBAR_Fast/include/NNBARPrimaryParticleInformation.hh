...
//
//
/// \file NNBARPrimaryParticleInformation.hh
/// \brief Definition of the NNBARPrimaryParticleInformation class

#ifndef NNBAR_PRIMARY_PARTICLE_INFORMATION_H
#define NNBAR_PRIMARY_PARTICLE_INFORMATION_H
...
class NNBARPrimaryParticleInformation : public G4VUserPrimaryParticleInformation {
  public:
    ...
    NNBARPrimaryParticleInformation( G4int aID, G4int aPDG, G4double aKineticEnergy, G4ThreeVector aMomentum, G4ThreeVector aMCPosition );

    virtual ~NNBARPrimaryParticleInformation();
