...
//
//
/// \file NNBARFastSimModelEMCal.hh
/// \brief Definition of the NNBARFastSimModelEMCal class

#ifndef NNBAR_EMCAL_FAST_SIM_MODEL_H
#define NNBAR_EMCAL_FAST_SIM_MODEL_H
...
/// is smeared (by NNBARSmearer::SmearMomentum()). Based on G4 
/// examples/extended/parametrisations/Par01/include/Par01EMShowerModel.hh .
/// @author Anna Zaborowska
//Modified by Andre Nepomuceno

class NNBARFastSimModelEMCal : public G4VFastSimulationModel {
  public:
    ...
    NNBARFastSimModelEMCal( G4String aModelName, G4Region* aEnvelope, 
    ...
    /// A constructor.
    /// @param aModelName A name of the fast simulation model.
    NNBARFastSimModelEMCal( G4String aModelName );

    ~NNBARFastSimModelEMCal();
    ...
    /// and efficiency to the NNBARPrimaryParticleInformation.
    /// @param aFastTrack A track.
