...
//
//
/// \file NNBARTrackingAction.hh
/// \brief Definition of the NNBARTrackingAction class

#ifndef NNBAR_TRACKING_ACTION_H
#define NNBAR_TRACKING_ACTION_H
...
class NNBARTrackingAction : public G4UserTrackingAction {
  public:
    
    /// A default constructor.
    NNBARTrackingAction();

    virtual ~NNBARTrackingAction();
