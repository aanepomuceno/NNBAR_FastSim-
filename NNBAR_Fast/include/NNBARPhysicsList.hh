...
//
//
/// \file NNBARPhysicsList.hh
/// \brief Definition of the NNBARPhysicsList class

#ifndef NNBAR_PHYSICS_LIST_H
#define NNBAR_PHYSICS_LIST_H
...
class NNBARPhysicsList : public G4VUserPhysicsList {
  public:
    
    /// A default constructor. Sets the default cut value.
    NNBARPhysicsList();

    virtual ~NNBARPhysicsList();
